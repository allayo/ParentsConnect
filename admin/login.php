...
// Handle form submission (Admin) admin login details (username: admin and password: admin)
...
<head>
    ...
    <title>Admin Login - Parents Connect</title>
    ...
    <div class="container loginBody">
        ...
        <div class="loginContent">
            <div class="loginFormText">
                <h4>Admin Login</h4>
                <p>Use a valid username and password to gain access to the administration backend</p>
                <a href="../login.php" class="regPageBtn">Go to User Login</a>
            </div>
            <div class="loginForm">
                <h3>Login</h3>
...
<script src="../assets/js/ytSearchAPI.js"></script>
</body>
</html>